...
SOURCES_FILE="flatpak/gradle-sources.json"
...
echo "These directories should be empty"
gradle_user_home="build/gradle_flatpak"
maven_repo="build/maven_flatpak"
...
find . -type f -print0 | while IFS= read -r -d '' file; do
	...
	echo "mavenize $file -> $(mavenize "$file")"
	target_dir="$wd/$maven_repo/$(mavenize "$file")"
